<fieldset>
	...
	<label for="imagen">Imagen:</label>
 	<input type="file" id="imagen" name="propiedad[imagen]" accept="image/jepg, img/png">
	...
	<label for="descripcion">Descripcion:</label>
 	...
 	<fieldset>
		...
		<!-- <select name = "vendedorId">
 		<option value="" name = "vendedor">--Seleccione--</option>	

 	 	<?php while($vendedor = mysqli_fetch_assoc($resVendedores)): ?>			
 	 	<option <?php echo $vendedorId === $vendedor['id'] ? 'selected' :''; ?> value="<?php echo s($propiedad->vendedroId); ?>" > 
